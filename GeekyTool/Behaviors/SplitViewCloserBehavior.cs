...
{
    public class SplitViewCloserBehavior : DependencyObject, IBehavior
    {
        ...
        public static readonly DependencyProperty SplitterProperty =
            DependencyProperty.Register("Splitter", typeof(SplitView), typeof(SplitViewCloserBehavior), new PropertyMetadata(null));
